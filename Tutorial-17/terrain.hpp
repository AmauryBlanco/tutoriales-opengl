#ifndef TERRAIN_OGL_H
#define TERRAIN_OGL_H
...
class Terrain {
    OpenGLShader terrain_shader;
    GLuint terrainTextureID, terrainVAO, terrainIndices;

public:
    void init() {
        terrainTextureID = initTerrain(terrain_shader, terrainVAO, terrainIndices);
    }

    void render(OpenGLCamera& camera) {
        renderTerrain(terrain_shader, camera, terrainTextureID, terrainVAO, terrainIndices);
    }
...
private:
    ...
    void createPlainTerrain(int WIDTH, int DEPTH, std::vector<GLubyte>& altura, GLuint& vao, GLuint& indices_count) {
    ...
    void renderTerrain(OpenGLShader& shader, OpenGLCamera& camera, GLuint terrainTextureID, GLuint vao, GLuint indices_count) {
        shader.use();
    ...
    GLuint initTerrain(OpenGLShader& shader, GLuint& vao, GLuint& indices) {
        ...
        createPlainTerrain(texture_width, texture_height, altura, vao, indices);

        return loadTerrainTexture("image/terreno.jpg");
    }
